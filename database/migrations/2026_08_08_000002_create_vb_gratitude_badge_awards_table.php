...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('vb_gratitude_badge_awards')) {
            Schema::create('vb_gratitude_badge_awards', function (Blueprint $table) {
    ...
    public function down(): void
    {
        ...
        DB::unprepared("DROP POLICY IF EXISTS {$t}_tenant_isolation ON public.{$t};");
        Schema::dropIfExists('vb_gratitude_badge_awards');
    }
};
